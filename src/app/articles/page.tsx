    ...
    <div style={{ background: "#F6F8FF", minHeight: "100vh" }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4"
          style={{ background: "linear-gradient(135deg,#EEF2FF,#F5F3FF)", border: "1px solid rgba(99,102,241,0.20)" }}>
          <div>
            <div className="font-bold text-base text-slate-900">Stay up to date</div>
            <div className="text-slate-500 text-sm mt-0.5">Get weekly EV news and guides delivered to your inbox.</div>
          </div>
          <div className="flex gap-2 w-full sm:w-auto">
            <input
              type="email"
              placeholder="you@example.com"
              className="flex-1 sm:w-52 px-3 py-2.5 rounded-xl text-sm bg-white text-slate-900 placeholder-slate-400 focus:outline-none"
              style={{ border: "1.5px solid #D1D9F0" }}
            />
            <button
              className="font-semibold text-sm px-5 py-2.5 rounded-xl text-white whitespace-nowrap transition-all hover:opacity-90"
