...
export async function POST(req: NextRequest) {
  ...
  const atto3 = await upsertEv("byd-atto-3", {
    ...
    battery: { create: {
      ...
      warrantyYears: 8, cycleLife: 5000 as any,
    }},
    charging: { create: [
  ...
  const lumin = await upsertEv("changan-lumin", {
    ...
    battery: { create: {
      chemistry: "NMC", capacityKwh: 72.6, voltage: 400, thermalManagement: "liquid",
      fastChargeCycles: 1500, degradationRate: 2.0, warrantyYears: 8, cycleLife: 2000 as any,
    }},
    charging: { create: [
  ...
  await upsertEv("mg-4-ev", {
    ...
    battery: { create: {
      ...
      thermalManagement: "liquid", fastChargeCycles: 1500, warrantyYears: 8, cycleLife: 2000 as any,
    } as any},
    charging: { create: [
  ...
  await upsertEv("kia-ev6", {
    ...
    battery: { create: {
      chemistry: "NMC", capacityKwh: 77.4, voltage: 800, thermalManagement: "liquid",
      fastChargeCycles: 1500, warrantyYears: 8, cycleLife: 2000 as any,
    }},
    charging: { create: [
  ...
  await upsertEv("chery-omoda-e5", {
    ...
    battery: { create: {
      chemistry: "LFP", capacityKwh: 17.6, voltage: 100, thermalManagement: "air",
      fastChargeCycles: 2000, warrantyYears: 3, cycleLife: 3000 as any,
    }},
    charging: { create: [
      { connectorType: "CCS2", maxDcKw: 80, maxAcKw: 7, chargingStandard: "CCS" },
    ]},
  ...
  await upsertEv("proton-e50", {
    ...
    battery: { create: {
      chemistry: "LFP Blade", capacityKwh: 82.5, voltage: 550, thermalManagement: "blade",
      fastChargeCycles: 3000, degradationRate: 1.2, warrantyYears: 8, cycleLife: 5000 as any,
    }},
    charging: { create: [
      { connectorType: "CCS2", maxDcKw: 80, maxAcKw: 11, chargingStandard: "CCS" },
    ]},
  ...
  await upsertEv("volvo-ex30", {
    ...
    battery: { create: {
      chemistry: "NMC", capacityKwh: 75, voltage: 400, thermalManagement: "liquid",
      fastChargeCycles: 1500, warrantyYears: 8, cycleLife: 2000 as any,
    }},
    charging: { create: [
